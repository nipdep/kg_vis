...
---
Enable QEMU emulation on your host

You can install and register QEMU emulation support for cross-architecture builds.
...
docker buildx build --platform linux/amd64 -t kg_vis:latest .


✅ This lets your ARM host execute amd64 containers for building.